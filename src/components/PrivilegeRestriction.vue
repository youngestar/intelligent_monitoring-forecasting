<template>
    ...
    <div ref="chartRef" style="width: 100%; height: 29vh; position: relative; bottom: 2vh;"></div>
</template>
...
function makeOption(type, symbol) {
    return {
        ...
        legend: {
            // 增加图例到 4 项
            data: ['系统核心权限抑制', '用户自定义权限抑制', '敏感数据访问权限抑制', '外部接口调用权限抑制'],
            // 设置图例字体颜色
            textStyle: {
                color: '#00BFFF',
                fontSize: 14
